...
L'orario effettivo di lezione è Lunedì 14.00-15.30 e Mercoledì 10.00-11.30 in aula U6-26.

Durante la prima lezione verranno valutate possibili soluzioni diverse per l'orario.
...
1. Implementare albero di suffisso. Alberi di suffisso generalizzati. Applicazioni degli alberi di suffisso: sottostringa più lunga. 
...
1. Array di suffisso: algoritmi per il pattern matching.  Pattern matching su testi circolari. Compressione tipo Lempel-Ziv con alberi di suffisso.
1. Algoritmo per calcolare lca di due foglie in tempo costante. Grafo delle
parole (DAWG). Calcolo della massima estensione 
